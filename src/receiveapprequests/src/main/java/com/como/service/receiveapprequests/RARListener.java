...
public class RARListener {
    ...
    private String processAppURI = "http://ip-10-0-1-137.ap-southeast-1.compute.internal:8080" + "/gateway";
    
    @CrossOrigin("http://ip-10-0-1-137.ap-southeast-1.compute.internal:8080/app")
