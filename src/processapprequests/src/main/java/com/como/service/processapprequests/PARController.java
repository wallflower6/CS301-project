...
public class PARController {
    ...
    private String receiveAPIURL = "http://ec2-13-213-192-106.ap-southeast-1.compute.amazonaws.com:8080" + "/gateway";


    // Consumes requests from ReceiveAppRequests (8081)
    @CrossOrigin("http://ec2-18-138-153-99.ap-southeast-1.compute.amazonaws.com:8080")
    ...
    @CrossOrigin("http://ec2-18-138-153-99.ap-southeast-1.compute.amazonaws.com:8080") // change to url of RApp instance
    @PostMapping("/aws-test")
    public ResponseEntity<String> awsIntegrationTest(@RequestBody String data) {
        String receiveApiUrl = "http://ec2-13-213-192-106.ap-southeast-1.compute.amazonaws.com" + "/aws-test"; // change host to RApi
