...
var baseurl = "http://ec2-18-140-152-81.ap-southeast-1.compute.amazonaws.com:8080"
...
function requestAuthorization(registerDetails) {
    ...
    fetch("http://ec2-18-140-152-81.ap-southeast-1.compute.amazonaws.com:8080/process-registration", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
